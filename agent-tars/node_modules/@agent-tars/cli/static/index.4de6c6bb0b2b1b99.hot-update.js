 ...
 */ const WorkspaceDetail = ()=>{
    ...
    const getStandardizedContent = ()=>{
        ...
        if (type === 'browser_vision_control') {
            ...
            // 如果这是环境增强，包含原始截图数据
            const environmentImage = isEnhancingEnvironment && Array.isArray(activePanelContent.originalContent) ? extractImageUrl(activePanelContent.originalContent) : null;
...
(() => {
__webpack_require__.h = () => ("fd6ae39ac0bc3ac4")
})();

}
);
//# sourceMappingURL=index.4de6c6bb0b2b1b99.hot-update.js.map