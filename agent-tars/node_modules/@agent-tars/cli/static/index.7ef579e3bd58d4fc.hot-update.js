...
// /multimodal/agent-tars-web-ui/src/v2/state/actions/eventProcessor.ts
/**
 ...
 */ function handleAssistantMessage(get, set, sessionId, event) {
    ...
    const currentPanelContent = get(_atoms_ui__WEBPACK_IMPORTED_MODULE_2__.activePanelContentAtom);
    // 如果当前没有面板内容，或者面板内容不是最新的，尝试关联最近的环境输入
    if (!currentPanelContent || currentPanelContent.type !== 'browser_vision_control') {
        // 从后往前查找最近的环境输入
...
(() => {
__webpack_require__.h = () => ("08a5daabe3085c6d")
})();

}
);
//# sourceMappingURL=index.7ef579e3bd58d4fc.hot-update.js.map