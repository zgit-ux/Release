...
/* ESM import */var jotai__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("../node_modules/.pnpm/jotai@2.12.5_@types+react@18.3.23_react@18.3.1/node_modules/jotai/esm/vanilla.mjs");
/* ESM import */var uuid__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("../node_modules/.pnpm/uuid@9.0.1/node_modules/uuid/dist/esm-browser/v4.js");
...
/* ESM import */var _atoms_replay__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/v2/state/atoms/replay.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("../node_modules/.pnpm/@rspack+plugin-react-refresh@1.0.3_react-refresh@0.16.0/node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
 ...
 */ const processEventAction = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(null, (get, set, params)=>{
    const { sessionId, event } = params;
    const replayState = get(_atoms_replay__WEBPACK_IMPORTED_MODULE_4__.replayStateAtom);
...
const updateProcessingStatusAction = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(null, (get, set, status)=>{
 ...
 */ function handleStreamingMessage(get, set, sessionId, event) {
    set(_atoms_message__WEBPACK_IMPORTED_MODULE_0__.messagesAtom, (prev)=>{
        ...
        // 创建新消息
        const newMessage = {
            id: event.id || (0,uuid__WEBPACK_IMPORTED_MODULE_6__["default"])(),
            role: 'assistant',
            content: event.content,
            timestamp: event.timestamp,
            isStreaming: !event.isComplete,
        ...
        if (messageIndex !== -1) {
            ...
            if (result.type === 'browser_vision_control') {
                ...
                for(let i = sessionMessages.length - 1; i >= 0; i--){
                    ...
                    if (msg.role === 'environment' && Array.isArray(msg.content)) {
                        const hasImage = msg.content.some((item)=>item.type === 'image_url' && item.image_url && item.image_url.url);
                        if (hasImage) {
...
(() => {
__webpack_require__.h = () => ("049947784d71f820")
})();

}
);
//# sourceMappingURL=index.3c78edd474dd80d3.hot-update.js.map