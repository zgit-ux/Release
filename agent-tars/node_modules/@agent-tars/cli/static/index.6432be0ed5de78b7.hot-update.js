 ...
 */ function handleEnvironmentInput(set, sessionId, event) {
    ...
    // Also add to tool results to be displayed in workspace
    if (Array.isArray(event.content) && event.content.some((c)=>c.type === 'image_url')) {
        const result = {
            id: event.id || (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
            toolCallId: `env-input-${event.id || (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])()}`,
            name: event.description || 'Browser Screenshot',
            content: event.content,
            timestamp: event.timestamp,
            type: (0,_utils_formatters__WEBPACK_IMPORTED_MODULE_3__.determineToolType)(event.description || 'browser', event.content)
        };
        set(_atoms_tool__WEBPACK_IMPORTED_MODULE_1__.toolResultsAtom, (prev)=>{
            const sessionResults = prev[sessionId] || [];
            return {
...
(() => {
__webpack_require__.h = () => ("d66dfd12206248ef")
})();

}
);
//# sourceMappingURL=index.6432be0ed5de78b7.hot-update.js.map