 ...
 */ function handleEnvironmentInput(set, sessionId, event) {
    ...
    const hasImage = Array.isArray(event.content) && event.content.some((part)=>part.type === 'image_url');
    if (hasImage) {
        const resultType = (0,_utils_formatters__WEBPACK_IMPORTED_MODULE_3__.determineToolType)(event.description || 'Environment Input', event.content);
        if (resultType === 'image') {
            const result = {
                id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
                toolCallId: event.id,
...
(() => {
__webpack_require__.h = () => ("3ec7d9c1b226887b")
})();

}
);
//# sourceMappingURL=index.59dfb7efdf53ea44.hot-update.js.map