...
/* ESM import */var _state_actions_eventProcessor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/v2/state/actions/eventProcessor.ts");
 ...
 */ const BrowserControlRenderer = (param)=>{
    ...
    _s();
    const { activeSessionId, activePanelContent } = (0,_hooks_useSession__WEBPACK_IMPORTED_MODULE_2__.useSession)();
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        if (activePanelContent && activePanelContent.environmentImage) {
            var _imgContent_image_url;
            // 从activePanelContent中获取图像
            const imgContent = activePanelContent.environmentImage.find((c)=>{
                var _c_image_url;
                return typeof c === 'object' && c.type === 'image_url' && ((_c_image_url = c.image_url) === null || _c_image_url === void 0 ? void 0 : _c_image_url.url);
            });
            if (imgContent && ((_imgContent_image_url = imgContent.image_url) === null || _imgContent_image_url === void 0 ? void 0 : _imgContent_image_url.url)) {
                setRelatedImage(imgContent.image_url.url);
                return;
            }
        }
        // 从映射表获取最新的环境图像
        const latestImage = _state_actions_eventProcessor__WEBPACK_IMPORTED_MODULE_4__.latestEnvironmentImageMap.get(activeSessionId);
        if (latestImage && latestImage.image) {
            const imgContent = latestImage.image.find((c)=>typeof c === 'object' && c.type === 'image_url');
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
        className: "space-y-4",
        children: [
            relatedImage && /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(framer_motion__WEBPACK_IMPORTED_MODULE_5__.motion.div, {
                initial: {
                    opacity: 0,
                    y: 10
                },
                ...
                children: /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_BrowserShell__WEBPACK_IMPORTED_MODULE_3__.BrowserShell, {
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                        ...
                        children: [
                            ...
                            mousePosition && imageSize && /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(framer_motion__WEBPACK_IMPORTED_MODULE_5__.motion.div, {
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_icons_fi__WEBPACK_IMPORTED_MODULE_6__.FiMousePointer, {
                            ...
                            thought && /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_icons_fi__WEBPACK_IMPORTED_MODULE_6__.FiEye, {
                            ...
                            step && /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                                        className: "flex items-center text-sm font-medium text-gray-700 dark:text-gray-300",
                                        children: [
                                            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_icons_fi__WEBPACK_IMPORTED_MODULE_6__.FiChevronsRight, {
                            ...
                            action && /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                                        className: "flex items-center text-sm font-medium text-gray-700 dark:text-gray-300",
                                        children: [
                                            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_icons_fi__WEBPACK_IMPORTED_MODULE_6__.FiType, {
...
_s(BrowserControlRenderer, "BqJXoyZFjdjk/rKijnOQnpb/TJ4=", false, function() {
    return [
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  latestEnvironmentImageMap: () => (latestEnvironmentImageMap),
...
// 新增：存储最新环境输入图像的映射表，供browser_vision_control使用
const latestEnvironmentImageMap = new Map();
// 存储最新环境输入图像的映射表，供browser_vision_control使用
const latestEnvironmentImageMap = new Map();
/**
 ...
 */ function handleToolResult(set, sessionId, event) {
    ...
    // 如果是browser_vision_control类型，特殊处理
    if (result.type === 'browser_vision_control') {
        // 获取最新的环境输入图像
        const latestEnvironmentImage = latestEnvironmentImageMap.get(sessionId);
        // Set as active panel content, including latest environment image info
        set(_atoms_ui__WEBPACK_IMPORTED_MODULE_2__.activePanelContentAtom, {
            type: result.type,
            ...
            arguments: args,
            // 添加当前最新的环境输入图像信息
            environmentImage: latestEnvironmentImage === null || latestEnvironmentImage === void 0 ? void 0 : latestEnvironmentImage.image,
            environmentImageDescription: latestEnvironmentImage === null || latestEnvironmentImage === void 0 ? void 0 : latestEnvironmentImage.description,
            environmentImageTimestamp: latestEnvironmentImage === null || latestEnvironmentImage === void 0 ? void 0 : latestEnvironmentImage.timestamp
        });
    } else {
        // 其他类型的工具调用，按原有逻辑处理
        set(_atoms_ui__WEBPACK_IMPORTED_MODULE_2__.activePanelContentAtom, {
 ...
 * Adds it to messages and updates the stored image reference
 */ function handleEnvironmentInput(set, sessionId, event) {
    ...
    // 检查内容是否包含图片
    if (Array.isArray(event.content) && event.content.some((part)=>part.type === 'image_url')) {
        // 存储最新的环境输入图像，以供browser_vision_control使用
        latestEnvironmentImageMap.set(sessionId, {
            image: event.content,
            description: event.description || 'Browser Screenshot',
            timestamp: event.timestamp
        });
        // 获取当前活动面板内容
        const activePanelContent = set.get(_atoms_ui__WEBPACK_IMPORTED_MODULE_2__.activePanelContentAtom);
        // 只有当当前不是显示browser_vision_control时，才设置环境输入为活动面板内容
        if (!activePanelContent || activePanelContent.type !== 'browser_vision_control') {
            set(_atoms_ui__WEBPACK_IMPORTED_MODULE_2__.activePanelContentAtom, {
                type: 'image',
                source: event.content,
                title: event.description || 'Browser Screenshot',
                timestamp: event.timestamp,
                isEnvironmentInput: true
            });
        }
    }
}
...
// 导出latestEnvironmentImageMap以供其他组件使用
...
(() => {
__webpack_require__.h = () => ("1d24d194003e50d7")
})();

}
);
//# sourceMappingURL=index.b9b56e4d57900fe1.hot-update.js.map