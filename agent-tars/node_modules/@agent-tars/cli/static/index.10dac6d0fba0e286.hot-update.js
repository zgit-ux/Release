 ...
 */ function handleStreamingToolCall(get, set, sessionId, event) {
    ...
    set(_atoms_tool__WEBPACK_IMPORTED_MODULE_2__.streamingToolCallsAtom, (prev)=>{
        ...
        const accumulatedArguments = existingCall ? existingCall.arguments + argumentsDelta : argumentsDelta;
        const streamingCall = {
            id: (existingCall === null || existingCall === void 0 ? void 0 : existingCall.id) || (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
            toolCallId,
            toolName,
 ...
 */ function updateMessageWithStreamingToolCall(get, set, sessionId, messageId, streamingCall) {
    set(_atoms_message__WEBPACK_IMPORTED_MODULE_1__.messagesAtom, (prev)=>{
        ...
        try {
            if (streamingCall.arguments.trim()) {
                parsedArguments = JSON.parse((0,jsonrepair__WEBPACK_IMPORTED_MODULE_8__.jsonrepair)(streamingCall.arguments));
            }
        } catch (error) {
        ...
        const updatedToolCalls = toolCallIndex >= 0 ? existingToolCalls.map((tc, idx)=>idx === toolCallIndex ? toolCall : tc) : [
            ...existingToolCalls,
            toolCall
        ];
    ...
    if (streamingCall.arguments.trim()) {
        try {
            const parsedArgs = JSON.parse((0,jsonrepair__WEBPACK_IMPORTED_MODULE_8__.jsonrepair)(streamingCall.arguments));
 ...
 */ function updateWorkspacePanelForStreamingTool(get, set, sessionId, toolCallId, toolName, event) {
    ...
    if (!currentPanel || currentPanel.toolCallId === toolCallId) {
        ...
        const streamingCalls = get(_atoms_tool__WEBPACK_IMPORTED_MODULE_2__.streamingToolCallsAtom)[sessionId] || {};
        const streamingCall = streamingCalls[toolCallId];
        if (streamingCall === null || streamingCall === void 0 ? void 0 : streamingCall.arguments) {
            try {
                parsedArgs = JSON.parse((0,jsonrepair__WEBPACK_IMPORTED_MODULE_8__.jsonrepair)(streamingCall.arguments));
            } catch (error) {
 ...
 */ const ToolCalls = (param)=>{
    ...
    const getDescriptionFromArgs = (toolName, args, isStreaming)=>{
...
(() => {
__webpack_require__.h = () => ("7f133921c86bde02")
})();

}
);
//# sourceMappingURL=index.10dac6d0fba0e286.hot-update.js.map