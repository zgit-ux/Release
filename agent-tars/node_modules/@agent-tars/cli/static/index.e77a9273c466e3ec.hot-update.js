...
/* ESM import */var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/v2/types/index.ts");
/* ESM import */var _atoms_message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/v2/state/atoms/message.ts");
/* ESM import */var _atoms_tool__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/v2/state/atoms/tool.ts");
/* ESM import */var _atoms_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/v2/state/atoms/ui.ts");
/* ESM import */var _utils_formatters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/v2/utils/formatters.ts");
/* ESM import */var _atoms_plan__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/v2/state/atoms/plan.ts");
 ...
 */ const processEventAction = (0,jotai__WEBPACK_IMPORTED_MODULE_7__.atom)(null, (get, set, params)=>{
    ...
    switch(event.type){
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.USER_MESSAGE:
            handleUserMessage(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.ASSISTANT_MESSAGE:
            handleAssistantMessage(get, set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.ASSISTANT_STREAMING_MESSAGE:
            if (!isReplayMode) {
                handleStreamingMessage(get, set, sessionId, event);
            }
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.ASSISTANT_THINKING_MESSAGE:
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.ASSISTANT_STREAMING_THINKING_MESSAGE:
            handleThinkingMessage(get, set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.TOOL_CALL:
            handleToolCall(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.TOOL_RESULT:
            handleToolResult(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.SYSTEM:
            handleSystemMessage(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.ENVIRONMENT_INPUT:
            handleEnvironmentInput(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.AGENT_RUN_START:
            set(_atoms_ui__WEBPACK_IMPORTED_MODULE_3__.isProcessingAtom, true);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.AGENT_RUN_END:
            set(_atoms_ui__WEBPACK_IMPORTED_MODULE_3__.isProcessingAtom, false);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.PLAN_START:
            handlePlanStart(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.PLAN_UPDATE:
            handlePlanUpdate(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.PLAN_FINISH:
            handlePlanFinish(set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.FINAL_ANSWER:
            handleFinalAnswer(get, set, sessionId, event);
            break;
        case _types__WEBPACK_IMPORTED_MODULE_0__.EventType.FINAL_ANSWER_STREAMING:
            if (!isReplayMode) {
...
const updateProcessingStatusAction = (0,jotai__WEBPACK_IMPORTED_MODULE_7__.atom)(null, (get, set, status)=>{
 ...
 */ function handleToolResult(set, sessionId, event) {
    ...
    const result = {
        ...
        timestamp: event.timestamp,
        error: event.error,
        type: (0,_utils_formatters__WEBPACK_IMPORTED_MODULE_4__.determineToolType)(event.name, event.content),
        arguments: args
    };
    // 添加调试日志，显示确定的类型
 ...
 */ function handlePlanStart(set, sessionId, event) {
    ...
    set(_atoms_plan__WEBPACK_IMPORTED_MODULE_5__.plansAtom, (prev)=>({
            ...prev,
            [sessionId]: {
                steps: [],
                isComplete: false,
...
(() => {
__webpack_require__.h = () => ("3f11353d44cb26b0")
})();

}
);
//# sourceMappingURL=index.e77a9273c466e3ec.hot-update.js.map