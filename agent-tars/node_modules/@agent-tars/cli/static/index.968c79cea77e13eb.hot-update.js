 ...
 */ function determineToolType(name, content) {
    ...
    if (lowerName === 'write_file') {
        return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    }
    // Check the tool name first
    if (lowerName.includes('search') || lowerName.includes('web_search')) return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    if (lowerName.includes('browser')) return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    if (lowerName.includes('command') || lowerName.includes('terminal') || lowerName === 'run_command') return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    if (lowerName.includes('file') || lowerName.includes('document')) return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    // 检查内容是否是新格式的搜索结果
...
(() => {
__webpack_require__.h = () => ("542e51c1875cc176")
})();

}
);
//# sourceMappingURL=index.968c79cea77e13eb.hot-update.js.map