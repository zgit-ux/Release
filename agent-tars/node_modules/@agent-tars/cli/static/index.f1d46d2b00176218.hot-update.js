    ...
    const getStandardizedContent = ()=>{
        ...
        switch(type){
            ...
            case 'search':
                ...
                if (Array.isArray(source) && typeof source[0] === 'object' && 'title' in source[0] && 'url' in source[0]) {
                    return [
                        {
                            type: 'search_result',
                            name: 'SEARCH_RESULTS',
...
(() => {
__webpack_require__.h = () => ("488cd4c823bdcaf8")
})();

}
);
//# sourceMappingURL=index.f1d46d2b00176218.hot-update.js.map