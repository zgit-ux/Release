 ...
 */ function handleFinalAnswer(get, set, sessionId, event) {
    ...
    // 查找最近的环境输入截图
    const messages = get(_atoms_message__WEBPACK_IMPORTED_MODULE_0__.messagesAtom);
    ...
    for(let i = sessionMessages.length - 1; i >= 0; i--){
        ...
        if (msg.role === 'environment' && Array.isArray(msg.content)) {
            ...
            if (imgContent && 'image_url' in imgContent && imgContent.image_url.url) {
                environmentImage = imgContent.image_url.url;
                break;
            }
        }
    }
...
(() => {
__webpack_require__.h = () => ("23dd859d03c80225")
})();

}
);
//# sourceMappingURL=index.afc0e30b66e20dbe.hot-update.js.map