 ...
 */ const WorkspaceDetail = ()=>{
    ...
    const getStandardizedContent = ()=>{
        ...
        if (type === 'browser_vision_control') {
            console.log('activePanelContent.originalContent', activePanelContent.originalContent, activePanelContent.environmentId);
            // 检查这是否是对环境截图的增强
            ...
            console.log('[GUI] prev environmentImage', environmentImage);
...
(() => {
__webpack_require__.h = () => ("3fda710a13cc0aa8")
})();

}
);
//# sourceMappingURL=index.2c47ac2fe4a972d7.hot-update.js.map