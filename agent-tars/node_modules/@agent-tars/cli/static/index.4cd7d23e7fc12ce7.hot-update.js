 ...
 */ const SidebarContainer = ()=>{
    _s();
    const { isSidebarCollapsed, toggleSidebar } = (0,_hooks_useLayout__WEBPACK_IMPORTED_MODULE_4__.useLayout)();
...
_s(SidebarContainer, "1tMZALQH5R0Rk9ZzqWwcJMm5NKI=", false, function() {
    return [
 ...
 */ class ApiService {
   ...
   */ async restoreSession(sessionId) {
        try {
            const response = await fetch(`${_constants__WEBPACK_IMPORTED_MODULE_0__.API_BASE_URL}${_constants__WEBPACK_IMPORTED_MODULE_0__.API_ENDPOINTS.RESTORE_SESSION}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
(() => {
__webpack_require__.h = () => ("7d05906f568b254a")
})();

}
);
//# sourceMappingURL=index.4cd7d23e7fc12ce7.hot-update.js.map