...
/* ESM import */var _main_state_atoms_message__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/main/state/atoms/message.ts");
/* ESM import */var _main_hooks_useReplay__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/main/hooks/useReplay.ts");
/* ESM import */var _main_state_atoms_replay__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./src/main/state/atoms/replay.ts");
/* ESM import */var _main_hooks_useReplayMode__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./src/main/hooks/useReplayMode.tsx");
 ...
 */ const ChatPanel = ()=>{
    _s();
    const { activeSessionId, isProcessing, connectionStatus, checkServerStatus } = (0,_main_hooks_useSession__WEBPACK_IMPORTED_MODULE_2__.useSession)();
    const groupedMessages = (0,jotai__WEBPACK_IMPORTED_MODULE_11__.useAtomValue)(_main_state_atoms_message__WEBPACK_IMPORTED_MODULE_5__.groupedMessagesAtom);
    const allMessages = (0,jotai__WEBPACK_IMPORTED_MODULE_11__.useAtomValue)(_main_state_atoms_message__WEBPACK_IMPORTED_MODULE_5__.messagesAtom);
    const [replayState] = (0,jotai__WEBPACK_IMPORTED_MODULE_11__.useAtom)(_main_state_atoms_replay__WEBPACK_IMPORTED_MODULE_7__.replayStateAtom);
    const isReplayMode = (0,_main_hooks_useReplayMode__WEBPACK_IMPORTED_MODULE_8__.useReplayMode)();
    const { cancelAutoPlay } = (0,_main_hooks_useReplay__WEBPACK_IMPORTED_MODULE_6__.useReplay)();
...
_s(ChatPanel, "ZHX+OWRjCT3BoWe5p2TKstqTNoU=", false, function() {
    return [
        ...
        _main_hooks_useReplayMode__WEBPACK_IMPORTED_MODULE_8__.useReplayMode,
...
(() => {
__webpack_require__.h = () => ("50a433d2764881a8")
})();

}
);
//# sourceMappingURL=index.92c371d49e558930.hot-update.js.map