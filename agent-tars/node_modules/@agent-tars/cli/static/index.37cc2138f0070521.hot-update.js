...
const CodeBlock = (param)=>{
    ...
    if (!match) {
        return /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("code", {
            className: "font-mono text-xs bg-purple-50 text-purple-700 px-1.5 py-0.5 rounded border border-purple-100 mx-0.5 leading-tight transition-colors",
            children: children
        }, void 0, false, {
...
(() => {
__webpack_require__.h = () => ("b96e22d97ea3e454")
})();

}
);
//# sourceMappingURL=index.37cc2138f0070521.hot-update.js.map