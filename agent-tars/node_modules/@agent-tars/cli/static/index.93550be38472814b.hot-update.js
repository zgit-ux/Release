...
// Handle streaming tool call event - accumulate arguments incrementally
function handleStreamingToolCall(get, set, sessionId, event) {
    ...
    streamingCall.arguments += argsDelta;
    // Update the message with streaming tool call
    set(_atoms_message__WEBPACK_IMPORTED_MODULE_1__.messagesAtom, (prev)=>{
        const sessionMessages = prev[sessionId] || [];
        const messageIdToFind = messageId;
        if (!messageIdToFind) return prev;
        const messageIndex = sessionMessages.findIndex((msg)=>msg.messageId === messageIdToFind);
        if (messageIndex === -1) {
...
(() => {
__webpack_require__.h = () => ("67c9c5bf23931080")
})();

}
);
//# sourceMappingURL=index.93550be38472814b.hot-update.js.map