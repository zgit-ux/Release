    ...
    if (Array.isArray(event.content)) {
        ...
        if (imageContent && imageContent.image_url) {
            set(_atoms_ui__WEBPACK_IMPORTED_MODULE_2__.activePanelContentAtom, (prev)=>{
                ...
                if (prev && prev.type === 'browser_vision_control' && prev.environmentId) {
                    return {
                        ...prev,
                        type: 'browser_vision_control',
                        source: event.content,
...
(() => {
__webpack_require__.h = () => ("6a58b1fbafa8bd26")
})();

}
);
//# sourceMappingURL=index.75cf2a059add07ee.hot-update.js.map