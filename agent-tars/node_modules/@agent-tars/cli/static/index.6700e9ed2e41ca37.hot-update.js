...
/* ESM import */var jsonrepair__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("../node_modules/.pnpm/jsonrepair@3.12.0/node_modules/jsonrepair/lib/esm/regular/jsonrepair.js");
...
// Store streaming tool call state for incremental argument building
const streamingToolCallsState = new Map();
/**
 ...
 */ function handleStreamingToolCall(get, set, sessionId, event) {
    ...
    let streamingState = streamingToolCallsState.get(toolCallId);
    if (!streamingState) {
        streamingState = {
            toolCallId,
            toolName,
        ...
        streamingToolCallsState.set(toolCallId, streamingState);
    }
    // Accumulate arguments
    streamingState.arguments += argumentsDelta;
    streamingState.isComplete = isComplete;
    // Try to parse accumulated arguments safely
    let parsedArguments = {};
    if (streamingState.arguments.trim()) {
        try {
            // Use jsonrepair to safely parse potentially incomplete JSON
            const repairedJson = (0,jsonrepair__WEBPACK_IMPORTED_MODULE_7__.jsonrepair)(streamingState.arguments);
    ...
    // Update the message with streaming tool call
    set(_atoms_message__WEBPACK_IMPORTED_MODULE_1__.messagesAtom, (prev)=>{
        const sessionMessages = prev[sessionId] || [];
        const messageIdToFind = messageId;
        ...
        if (existingMessageIndex !== -1) {
            ...
            const existingToolCallIndex = updatedToolCalls.findIndex((tc)=>tc.id === toolCallId);
            const toolCall = {
                id: toolCallId,
                type: 'function',
                function: {
            ...
            if (existingToolCallIndex !== -1) {
                updatedToolCalls[existingToolCallIndex] = toolCall;
            } else {
            ...
            const updatedMessage = {
                ...
                finishReason: isComplete ? 'tool_calls' : undefined
            };
            return {
                ...prev,
                [sessionId]: [
    ...
    // Clean up completed streaming state
    if (isComplete) {
        streamingToolCallsState.delete(toolCallId);
    }
}
/**
 ...
 */ function handleStreamingMessage(get, set, sessionId, event) {
    set(_atoms_message__WEBPACK_IMPORTED_MODULE_1__.messagesAtom, (prev)=>{
        ...
        // 创建新消息
        const newMessage = {
            id: event.id || (0,uuid__WEBPACK_IMPORTED_MODULE_8__["default"])(),
            role: 'assistant',
            content: event.content,
            timestamp: event.timestamp,
            isStreaming: !event.isComplete,
 ...
 */ function handleFinalAnswer(get, set, sessionId, event) {
    const messageId = event.messageId || `final-answer-${(0,uuid__WEBPACK_IMPORTED_MODULE_8__["default"])()}`;
...
"./src/standalone/chat/Message/components/ActionButton.tsx": (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
/* ESM import */var framer_motion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("../node_modules/.pnpm/framer-motion@12.19.2_@emotion+is-prop-valid@1.3.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs");
...
/**
 * ActionButton - Universal operation button component for tool calls and environment state viewing
 *
 * Design principles:
 * - Highlight visual differences of tool icons
 * - Consistent visual style and interaction experience
 * - Customizable status display
 * - Consistent animation effects
 * - Support for streaming states with enhanced visual feedback
 */ const ActionButton = (param)=>{
    let { icon, label, onClick, status = 'default', statusIcon, description } = param;
    ...
    return /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(framer_motion__WEBPACK_IMPORTED_MODULE_2__.motion.button, {
        ...
        children: [
            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                ...
                fileName: "/Users/chenhaoli/workspace/code/UI-TARS-desktop-5/multimodal/agent-tars-web-ui/src/standalone/chat/Message/components/ActionButton.tsx",
                lineNumber: 73,
                columnNumber: 7
            }, undefined),
            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                ...
                children: [
                    ...
                    description && /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("span", {
                        className: "font-[400] text-xs opacity-70 truncate ml-1",
            ...
            /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                ...
                children: statusIcon || /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_icons_fi__WEBPACK_IMPORTED_MODULE_3__.FiArrowRight, {
...
(() => {
__webpack_require__.h = () => ("28f1ba6b363da1df")
})();

}
);
//# sourceMappingURL=index.6700e9ed2e41ca37.hot-update.js.map