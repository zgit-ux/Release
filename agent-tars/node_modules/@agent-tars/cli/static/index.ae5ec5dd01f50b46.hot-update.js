 ...
 */ const WorkspaceDetail = ()=>{
    ...
    const getStandardizedContent = ()=>{
        ...
        switch(type){
            ...
            case 'browser':
                if (toolName.includes('navigate') || toolName.includes('markdown')) {
                    let textContent = '';
...
(() => {
__webpack_require__.h = () => ("fa99ef22145e729e")
})();

}
);
//# sourceMappingURL=index.ae5ec5dd01f50b46.hot-update.js.map