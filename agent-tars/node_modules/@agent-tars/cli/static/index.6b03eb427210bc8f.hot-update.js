        ...
        if (imageContent && imageContent.image_url) {
            set(_atoms_ui__WEBPACK_IMPORTED_MODULE_2__.activePanelContentAtom, (prev)=>{
                ...
                if (prev && prev.type === 'browser_vision_control') {
                    console.log('[GUI] prev 2', prev === null || prev === void 0 ? void 0 : prev.type);
                    return {
                        ...prev,
                        type: 'browser_vision_control',
...
(() => {
__webpack_require__.h = () => ("a9d88aa1c2f9def9")
})();

}
);
//# sourceMappingURL=index.6b03eb427210bc8f.hot-update.js.map