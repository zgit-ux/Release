 ...
 */ const sendMessageAction = (0,jotai__WEBPACK_IMPORTED_MODULE_8__.atom)(null, async (get, set, content)=>{
    ...
    // 检查是否是仅包含图片的消息
    const isImageOnlyMessage = Array.isArray(content) && content.every((part)=>part.type === 'image_url');
    // 添加用户消息到状态
    const userMessage = {
        ...
        content,
        timestamp: Date.now(),
        isImageMessage: isImageOnlyMessage
    };
    set(_atoms_message__WEBPACK_IMPORTED_MODULE_2__.messagesAtom, (prev)=>{
    ...
    try {
        ...
        if (messages.length <= 2 && typeof content === 'string') {
            // 算上刚刚添加的用户消息
            let summary = '';
...
(() => {
__webpack_require__.h = () => ("30b10db752b49c7d")
})();

}
);
//# sourceMappingURL=index.acaf666ead093dbf.hot-update.js.map