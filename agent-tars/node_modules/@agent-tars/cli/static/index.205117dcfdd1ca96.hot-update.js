...
/* ESM import */var _atoms_streamingToolCall__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/common/state/atoms/streamingToolCall.ts");
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'json-repair'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
 ...
 */ const processEventAction = (0,jotai__WEBPACK_IMPORTED_MODULE_8__.atom)(null, (get, set, params)=>{
...
const updateProcessingStatusAction = (0,jotai__WEBPACK_IMPORTED_MODULE_8__.atom)(null, (get, set, status)=>{
 ...
 */ function handleStreamingMessage(get, set, sessionId, event) {
    set(_atoms_message__WEBPACK_IMPORTED_MODULE_1__.messagesAtom, (prev)=>{
        ...
        // 创建新消息
        const newMessage = {
            id: event.id || (0,uuid__WEBPACK_IMPORTED_MODULE_9__["default"])(),
            role: 'assistant',
            content: event.content,
            timestamp: event.timestamp,
            isStreaming: !event.isComplete,
 ...
 */ function handleFinalAnswer(get, set, sessionId, event) {
    const messageId = event.messageId || `final-answer-${(0,uuid__WEBPACK_IMPORTED_MODULE_9__["default"])()}`;
 ...
 */ function handleStreamingToolCall(get, set, sessionId, event) {
    const streamingToolCalls = get(_atoms_streamingToolCall__WEBPACK_IMPORTED_MODULE_6__.streamingToolCallsAtom);
    ...
    set(_atoms_streamingToolCall__WEBPACK_IMPORTED_MODULE_6__.streamingToolCallsAtom, {
        ...streamingToolCalls,
        [sessionId]: {
            ...sessionToolCalls,
    ...
    if (event.isComplete) {
        ...
        setTimeout(()=>{
            set(_atoms_streamingToolCall__WEBPACK_IMPORTED_MODULE_6__.streamingToolCallsAtom, (prev)=>{
                const updated = {
                    ...prev
                };
 ...
 */ function handleWriteFileStreaming(get, set, sessionId, streamingState, isComplete) {
    try {
        ...
        if (streamingState.accumulatedArguments.trim()) {
            try {
                ...
                try {
                    ...
                    const repairedJson = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'json-repair'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(streamingState.accumulatedArguments);
 ...
 */ function extractPartialArgs(jsonString) {
    const result = {};
...
"./src/common/state/atoms/streamingToolCall.ts": (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
(() => {
__webpack_require__.h = () => ("6b911517eaa02ee5")
})();

}
);
//# sourceMappingURL=index.205117dcfdd1ca96.hot-update.js.map