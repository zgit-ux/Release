...
/* ESM import */var _main_hooks_useSession__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/main/hooks/useSession.ts");
/* provided dependency */ var $ReactRefreshRuntime$ = __webpack_require__("../node_modules/.pnpm/@rspack+plugin-react-refresh@1.0.3_react-refresh@0.16.0/node_modules/@rspack/plugin-react-refresh/client/reactRefresh.js");
 ...
 */ const HomePage = ()=>{
    _s();
    const { activeSessionId, sendMessage, createSession } = (0,_main_hooks_useSession__WEBPACK_IMPORTED_MODULE_3__.useSession)();
...
_s(HomePage, "poC5Fr+h8LDioF4TJ+tpsnKFoaE=", false, function() {
    return [
        _main_hooks_useSession__WEBPACK_IMPORTED_MODULE_3__.useSession,
...
const WelcomePage = ()=>{
    ...
    const { createSession, sendMessage, sessions } = Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../hooks/useSession'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
...
(() => {
__webpack_require__.h = () => ("3582d45448e344ea")
})();

}
);
//# sourceMappingURL=index.9a635e382b9c9f8a.hot-update.js.map