...
/* ESM import */var _shareService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/features/share/shareService.ts");
...
"./src/features/share/shareService.ts": (function (module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
 ...
 */ class ShareService {
   ...
   */ async getShareConfig() {
        ...
        try {
            const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error("Cannot find module '../constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/api/share/config`, {
                method: 'GET',
                headers: {
   ...
   */ async shareSession(sessionId) {
        ...
        try {
            const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error("Cannot find module '../constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/api/sessions/share`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
(() => {
__webpack_require__.h = () => ("a1af6a791171a36b")
})();

}
);
//# sourceMappingURL=index.e77f45c0eb2b4c97.hot-update.js.map