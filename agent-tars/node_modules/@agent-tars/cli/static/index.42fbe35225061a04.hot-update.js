...
function handleToolResult(set, sessionId, event) {
    ...
    const result = {
        ...
        timestamp: event.timestamp,
        error: event.error,
        type: (0,_common_utils_formatters__WEBPACK_IMPORTED_MODULE_3__.determineToolType)(event.name, event.content),
        arguments: args
    };
...
(() => {
__webpack_require__.h = () => ("61fe1e368a039e7d")
})();

}
);
//# sourceMappingURL=index.42fbe35225061a04.hot-update.js.map