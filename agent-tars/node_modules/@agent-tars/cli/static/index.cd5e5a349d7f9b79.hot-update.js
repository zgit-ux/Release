...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
 ...
 */ function determineToolType(name, content) {
    ...
    if (lowerName === 'write_file') {
        return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    }
    // Check the tool name first
    if (lowerName.includes('search') || lowerName.includes('web_search')) return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    if (lowerName.includes('browser')) return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    if (lowerName.includes('command') || lowerName.includes('terminal') || lowerName === 'run_command') return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    if (lowerName.includes('file') || lowerName.includes('document')) return Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    // 检查内容是否是新格式的搜索结果
...
/* ESM import */var _state_atoms_tool__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/main/state/atoms/tool.ts");
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
 ...
 */ function useTool() {
   ...
   */ const getToolIcon = (type)=>{
        ...
        switch(type){
            case Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()):
                return /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
                    className: "relative",
                    children: [
                        /*#__PURE__*/ (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)("div", {
 ...
 */ class ApiService {
   ...
   */ async checkServerHealth() {
        try {
            ...
            const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}`, {
                method: 'GET',
                headers: {
   ...
   */ async getSessionDetails(sessionId) {
        try {
            const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}?sessionId=${sessionId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                },
   ...
   */ async getBrowserControlInfo(sessionId) {
        try {
            const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/api/sessions/browser-control?sessionId=${sessionId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                },
 ...
 */ class SocketService {
   ...
   */ connect() {
        ...
        this.socket = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_0__.io)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
            reconnection: true,
            reconnectionDelay: Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
            reconnectionDelayMax: Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
            reconnectionAttempts: Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
        });
   ...
   */ joinSession(sessionId, onEvent, onStatusUpdate) {
        ...
        this.socket.emit(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), sessionId);
        // 清理现有监听器
        this.socket.off(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        this.socket.off(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        // 设置事件监听器
        this.socket.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), (param)=>{
            let { type, data } = param;
            if (data) {
                onEvent(data);
            }
        ...
        // 增强状态更新处理
        this.socket.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), (status)=>{
            console.log('Received agent status:', status);
            onStatusUpdate(status);
            // 触发全局事件以同步应用中的所有组件
            this.notifyEventHandlers(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), status);
        });
        // 立即请求当前状态
   ...
   */ sendQuery(params) {
        ...
        this.socket.emit(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), params);
    }
    /**
   ...
   */ ping() {
        return new Promise((resolve)=>{
            ...
            this.socket.emit(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), ()=>{
   ...
   */ setupEventHandlers() {
        if (!this.socket) return;
        this.socket.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), this.handleConnect);
        this.socket.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), this.handleDisconnect);
        this.socket.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), this.handleError);
        this.socket.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), this.handleReconnectAttempt);
        this.socket.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), this.handleReconnectFailed);
   ...
   */ sendHeartbeat() {
        if (!this.socket || !this.socket.connected) {
            ...
            if (this.missedHeartbeats >= Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())) {
                var _this_socket;
   ...
   */ (0,_swc_helpers_define_property__WEBPACK_IMPORTED_MODULE_2__._)(this, "handleConnect", ()=>{
            ...
            this.notifyEventHandlers(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        });
        /**
   ...
   */ (0,_swc_helpers_define_property__WEBPACK_IMPORTED_MODULE_2__._)(this, "handleDisconnect", (reason)=>{
            ...
            this.stopHeartbeat();
            // Notify event handlers
            this.notifyEventHandlers(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), reason);
        });
        /**
   ...
   */ (0,_swc_helpers_define_property__WEBPACK_IMPORTED_MODULE_2__._)(this, "handleError", (error)=>{
            ...
            // Notify event handlers
            this.notifyEventHandlers(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), error);
        });
        /**
   * Handle reconnection attempts
   */ (0,_swc_helpers_define_property__WEBPACK_IMPORTED_MODULE_2__._)(this, "handleReconnectAttempt", ()=>{
            this.reconnectAttempts++;
            console.log(`Reconnection attempt ${this.reconnectAttempts}/${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}`);
            // Notify event handlers
            this.notifyEventHandlers(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), this.reconnectAttempts);
        });
        /**
 ...
 */ const initConnectionMonitoringAction = (0,jotai__WEBPACK_IMPORTED_MODULE_4__.atom)(null, (get, set)=>{
    ...
    _services_socketService__WEBPACK_IMPORTED_MODULE_2__.socketService.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), ()=>{
    ...
    _services_socketService__WEBPACK_IMPORTED_MODULE_2__.socketService.on(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), (reason)=>{
        set(_atoms_ui__WEBPACK_IMPORTED_MODULE_3__.connectionStatusAtom, (prev)=>({
                ...prev,
                connected: false,
    ...
    return ()=>{
        ...
        _services_socketService__WEBPACK_IMPORTED_MODULE_2__.socketService.off(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), ()=>{});
        _services_socketService__WEBPACK_IMPORTED_MODULE_2__.socketService.off(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), ()=>{});
        _services_socketService__WEBPACK_IMPORTED_MODULE_2__.socketService.off(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), ()=>{});
        _services_socketService__WEBPACK_IMPORTED_MODULE_2__.socketService.off(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), ()=>{});
    };
 ...
 */ class ShareService {
   ...
   */ async getShareConfig() {
        ...
        try {
            const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/api/share/config`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                }
   ...
   */ async shareSession(sessionId) {
        ...
        try {
            const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/common/constants'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/api/sessions/share`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
(() => {
__webpack_require__.h = () => ("bdc0ad338db6111f")
})();

}
);
//# sourceMappingURL=index.cd5e5a349d7f9b79.hot-update.js.map