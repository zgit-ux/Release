...
class DeepResearchGenerator {
    async generateReport(llmClient, resolvedModel, eventStream, options, abortSignal) {
        try {
            ...
            const messageId = `research-report-${(0, __WEBPACK_EXTERNAL_MODULE_uuid__.v4)()}`;
            ...
            if (!this.hasEnoughInformationForReport(relevantData)) {
                ...
                const simpleAnswerEvent = eventStream.createEvent(__WEBPACK_EXTERNAL_MODULE__multimodal_mcp_agent_4b976ab5__.EventType.FINAL_ANSWER, {
            ...
            const finalEvent = eventStream.createEvent(__WEBPACK_EXTERNAL_MODULE__multimodal_mcp_agent_4b976ab5__.EventType.FINAL_ANSWER, {
    ...
    extractRelevantData(eventStream) {
        ...
        const userMessages = events.filter((e)=>e.type === __WEBPACK_EXTERNAL_MODULE__multimodal_mcp_agent_4b976ab5__.EventType.USER_MESSAGE);
        const toolResults = events.filter((e)=>e.type === __WEBPACK_EXTERNAL_MODULE__multimodal_mcp_agent_4b976ab5__.EventType.TOOL_RESULT);
        const assistantMessages = events.filter((e)=>e.type === __WEBPACK_EXTERNAL_MODULE__multimodal_mcp_agent_4b976ab5__.EventType.ASSISTANT_MESSAGE);
        const environmentInputs = events.filter((e)=>e.type === __WEBPACK_EXTERNAL_MODULE__multimodal_mcp_agent_4b976ab5__.EventType.ENVIRONMENT_INPUT);
    ...
    async streamSectionContent(llmClient, resolvedModel, sectionTitle, relevantData, options, messageId, fullReport, abortSignal) {
        try {
            ...
            __WEBPACK_EXTERNAL_MODULE_fs__["default"].writeFileSync(`${sectionPromptContent}-${Date.now()}.json`, JSON.stringify(sectionPromptContent, null, 2), 'utf-8');
    ...
    streamReportChunk(content, messageId, isComplete) {
        const streamingEvent = this.eventStream.createEvent(__WEBPACK_EXTERNAL_MODULE__multimodal_mcp_agent_4b976ab5__.EventType.FINAL_ANSWER_STREAMING, {
            content,
            isDeepResearch: true,
            isComplete,
            messageId
...
export { DeepResearchGenerator };

//# sourceMappingURL=deep-research-generator.mjs.map