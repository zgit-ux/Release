...
import { DeepResearchGenerator } from "./deep-research.mjs";
    ...
    getTools() {
        return [
            new Tool({
                ...
                parameters: z.object({
                    isDeepResearch: z.boolean().optional().describe('Whether to generate a structured report (true) or simple answer (false)'),
...
export { DEFAULT_PLANNING_PROMPT, PlanManager };

//# sourceMappingURL=plan-manager.mjs.map