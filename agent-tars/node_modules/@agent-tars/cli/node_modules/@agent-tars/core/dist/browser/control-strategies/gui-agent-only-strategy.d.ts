 ...
 */
export declare class GUIAgentOnlyStrategy extends AbstractBrowserControlStrategy {
    /**
     ...
     */
    private registerCustomBrowserTools;
}
//# sourceMappingURL=gui-agent-only-strategy.d.ts.map