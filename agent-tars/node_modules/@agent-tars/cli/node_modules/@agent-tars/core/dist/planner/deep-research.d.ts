import { ConsoleLogger, AgentEventStream, ResolvedModel, OpenAI } from '@mcp-agent/core';
/**
 ...
 */
export declare class DeepResearchGenerator {
    private logger;
    private eventStream;
     ...
     */
    generateReport(llmClient: OpenAI, resolvedModel: ResolvedModel, eventStream: AgentEventStream.Processor, options: ReportGenerationOptions, abortSignal?: AbortSignal): Promise<any>;
    /**
     * Check if there's enough information to generate a meaningful report
     */
    private hasEnoughInformationForReport;
    /**
